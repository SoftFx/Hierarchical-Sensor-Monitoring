...
| Reliability wave #1102 (E1/B2/C1/E2/E4/E5) | 26 fast | 80% | ~1 sec | `PerformanceCounterInstanceResolutionTests.cs`, `BoundedBlockingCallTests.cs`, `FileSensorBoundsTests.cs`, `RateSensorElapsedTimeTests.cs`, `TransportAndTimeNormalizationTests.cs` | aicontext `features/collector/overview.md`, раздел `Reliability hardening` |
