...
| Sensor cardinality | 1 fast + 2 gated/nightly | 80% | <1 sec fast; `100000` boundary ~1 sec; nightly 30 sec default / overnight configurable | `src/collector/HSMDataCollector.Tests/CollectorSensorCardinalityStressTests.cs` | [CollectorSensorCardinalityStressTests.md](CollectorSensorCardinalityStressTests.md) |
...
| Repeated high-cardinality cycles по времени | 1 gated/nightly | 80% | 30 sec default; overnight configurable | `Cardinality_registration_repeated_for_duration_stays_bounded` | `CollectorSensorCardinalityStressTests.cs` | [CollectorSensorCardinalityStressTests.md](CollectorSensorCardinalityStressTests.md), раздел `Nightly repeat` |
