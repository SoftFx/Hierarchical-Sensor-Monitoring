...
| Sensor cardinality | 1 fast + 2 gated/nightly | 80% | <1 sec fast; `100000` boundary ~1 sec; nightly 8 hours default | `src/collector/HSMDataCollector.Tests/CollectorSensorCardinalityStressTests.cs` | [CollectorSensorCardinalityStressTests.md](CollectorSensorCardinalityStressTests.md) |
