...
namespace HSMServer.Tests.DatabaseTests
{
    public class DatabaseAdapterTests : IClassFixture<DatabaseAdapterFixture>, IDisposable
    {
        ...
        public void ProductMustBeAdded()
        {
            ...
            var existingProduct = _databaseFixture.DatabaseCore.GetProduct(_databaseFixture.FirstProductName);
        ...
        public void ProductMustBeRemoved()
        {
            ...
            //Assert
            Assert.NotNull(_databaseFixture.DatabaseCore.GetProduct(_databaseFixture.SecondProductName));

            //Act
            _databaseFixture.DatabaseCore.RemoveProduct(product.Name);
            var correspondingProduct = _databaseFixture.DatabaseCore.GetProduct(product.Name);
        ...
        public void ExtraKeyMustBeAdded()
        {
            ...
            //Act
            _databaseFixture.DatabaseCore.UpdateProduct(product);

            //Assert
            var gotProduct = _databaseFixture.DatabaseCore.GetProduct(product.Name);
