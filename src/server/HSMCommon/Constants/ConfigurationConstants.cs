...
namespace HSMCommon.Constants
{
    public class ConfigurationConstants
    {
        ...
        public const string BotTokenDescription = $"Generated by BotFather secret access token. Installation by Telegram {_telegramWiki}";
        public const string BotNameDescription = $"Installed by BotFather botname. It must be ended with 'bot'. Installation by Telegram {_telegramWiki}";
        public const string AreBotMessagesEnabledDescription = "Can bot send messages.";

        private const string _telegramWiki = "<a href='https://core.telegram.org/bots#6-botfather' target='_blank'>Bot Installation</a>";
        #endregion
