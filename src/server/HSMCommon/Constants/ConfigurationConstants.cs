...
namespace HSMCommon.Constants
{
    public class ConfigurationConstants
    {
        ...
        public const string BotTokenDescription = $"Generated by BotFather secret access token.";
        public const string BotNameDescription = $"Installed by BotFather botname. It must be ended with 'bot'.";
