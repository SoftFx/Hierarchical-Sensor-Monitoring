...
namespace HSMServer.Dashboards
{
    public sealed record PanelRangeSettings
    {
        ...
        internal bool IsRangeScalePossible(SensorType sensorType) => sensorType is (SensorType.Double or SensorType.Integer or SensorType.DoubleBar or SensorType.IntegerBar or SensorType.Counter);
