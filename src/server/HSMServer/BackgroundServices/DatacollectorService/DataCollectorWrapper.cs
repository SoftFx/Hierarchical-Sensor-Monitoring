...
namespace HSMServer.BackgroundServices
{
    public sealed class DataCollectorWrapper : IDisposable
    {
        ...
        internal void SendDbInfo()
        {
            ...
            _historyDbSizeSensor.AddValue(GetRoundedDouble(_database.GetSensorsHistoryDatabaseSize()));
            _environmentDbSizeSensor.AddValue(GetRoundedDouble(_database.GetEnvironmentDatabaseSize()));
        }
