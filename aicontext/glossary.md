...
| TokenId / EntityId | API-token identity: TokenId is the public 128-bit authentication lookup key; EntityId is the stable GUID used by lifecycle routes. | Lifecycle and list responses expose EntityId, never the full TokenId or secret. |
