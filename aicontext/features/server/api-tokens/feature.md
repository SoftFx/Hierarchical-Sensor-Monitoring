...
- Free text (name, description, revocation reason) is bounded (256/1024/256 chars) and control-character-sanitized before persistence, so records cannot forge log lines.
