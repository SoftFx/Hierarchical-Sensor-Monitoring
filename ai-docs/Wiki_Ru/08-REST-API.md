...
- [[04-Основные-понятия]] — описание ключей доступа и типов датчиков
- [[16-Типы-датчиков]] — подробное описание типов датчиков
- [[20-Датчики]] — общая информация о датчиках и API-эндпоинтах
- [[25-Ключи-доступа]] — использование ключей для аутентификации API
