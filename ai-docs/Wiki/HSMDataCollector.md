...
- [Getting Started](Getting-Started) — How to get started with HSM
- [Sensor Types](Sensor-types) — Reference for all supported sensor types
- [Windows Sensors Collection](Windows-sensors-collection) — Built-in Windows sensors
- [Unix Sensors Collection](Unix-sensors-collection) — Built-in Unix/Linux sensors
- [DataCollector Statuses](DataCollector-statuses) — Understanding collector status values
- [DataCollector Logging](DataCollector-logging) — Configuring logging for DataCollector
- [DataCollector Sensor Settings](DataCollector-sensor-settings) — Sensor configuration options
- [HSM Architecture](HSM-architecture) — System architecture overview
- [Server Configuration](Server-Configuration) — Server-side configuration
