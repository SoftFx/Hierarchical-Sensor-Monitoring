...
The Alert Constructor is the visual interface in the HSM Web UI for building alert policies. It allows you to define conditions and actions using a block-based editor.

See also: [Alerts Overview](Alerts-Overview), [Alert Conditions Reference](Alert-Conditions-Reference)
...
- [Alerts Overview](Alerts-Overview) — Complete alert system documentation
- [Alert Conditions Reference](Alert-Conditions-Reference) — Available conditions for each sensor type
- [Alert Templates](Alert-Templates) — Apply alerts to many sensors at once
- [Alert Schedules](Alert-Schedules) — Working hours configuration
