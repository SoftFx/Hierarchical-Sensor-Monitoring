# Unix Sensors Collection

This page describes the built-in Unix/Linux sensors available in the HSM DataCollector.

See also: [HSM DataCollector](HSMDataCollector), [Windows Sensors Collection](Windows-sensors-collection), [Sensor Types](Sensor-types)
...
- [Windows Sensors Collection](Windows-sensors-collection) — Built-in sensors for Windows systems
