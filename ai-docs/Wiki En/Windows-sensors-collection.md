...
* [AddProcessCpu](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addprocesscpu)
* [AddProcessMemory](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addprocessmemory)
* [AddProcessThreadCount](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addprocessthreadcount)
...
The current method calls the following methods:
* [AddTotalCpu](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addtotalcpu)
* [AddFreeRamMemory](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addfreerammemory)
...
The current method calls the following methods:
* [AddFreeDiskSpace](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addfreediskspace)
* [AddFreeDiskSpacePrediction](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addfreediskspaceprediction)
...
The current method calls the following methods:
* [AddWindowsNeedUpdate](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addwindowsneedupdate)
* [AddWindowsLastUpdate](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addwindowslastupdate)
* [AddWindowsLastRestart](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Default-sensors-collection#addwindowslastrestart)
...
The current method calls the following methods:
* [AddCollectorAlive](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Windows-sensors-collection#addcollectoralive)
* [AddCollectorVersion](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Windows-sensors-collection#addcollectorversion)
* [AddCollectorStatus](https://github.com/SoftFx/Hierarchical-Sensor-Monitoring/wiki/Windows-sensors-collection#addcollectorstatus)
```C#
// Parameters:
//   options:
//     The custom options of the sensor to create. If options is null the default options are using.
