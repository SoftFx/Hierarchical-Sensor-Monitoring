...
```
`letsencrypt` needs a public DNS name pointing to this machine; for an IP address or an internal network use `self-signed`. See [Installation](Installation) for details.
